...
public class insertarCodigoCliente extends javax.swing.JFrame {
    ...
    Conexion con;
    public insertarCodigoCliente() {
        initComponents();
        try {
            con = new Conexion();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(insertarCodigoCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese código cliente: ");
