...
public class insertarFechasCompra extends javax.swing.JFrame {
    ...
    Conexion con;
    public insertarFechasCompra() {
        initComponents();
        try {
            con = new Conexion();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(insertarFechasCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jLabel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 468, Short.MAX_VALUE))
        );
...
resultDateTo = formatter.format(dateTo);
                ...
                String reporte="";
                    ...
                    reporte = con.pReporte_Compra_Fechas(resultDateFrom,resultDateTo);
