 ...
 * @author Edison
 */
public class AeroLeftButton extends JButton{
    ...
    public AeroLeftButton(Icon icon) {
        super(icon);
    }

    public AeroLeftButton() {
        setOpaque(false);
    ...
    private static Image loadImage(String fileName) {
        try {
            return ImageIO.read(AeroLeftButton.class.getResource(fileName));
    ...
    protected void paintComponent(Graphics g) {
        ...
        RoundRectangle2D.Float r2d = new RoundRectangle2D.Float(
                0,0,getWidth()+6,getHeight(),angle,angle);
        g2.clip(r2d);
