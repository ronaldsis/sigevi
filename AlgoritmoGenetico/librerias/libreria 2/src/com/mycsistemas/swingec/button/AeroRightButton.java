 ...
 * @author Edison
 */
public class AeroRightButton extends JButton{
    ...
    public AeroRightButton(Icon icon) {
        super(icon);
    }

    public AeroRightButton() {
        setOpaque(false);
    ...
    private static Image loadImage(String fileName) {
        try {
            return ImageIO.read(AeroRightButton.class.getResource(fileName));
    ...
    protected void paintComponent(Graphics g) {
        ...
        RoundRectangle2D.Float r2d = new RoundRectangle2D.Float(
                0-6,0,getWidth()+6,getHeight(),angle,angle);
        g2.clip(r2d);
