...
public class insertarCodigoProveedor extends javax.swing.JFrame {
    ...
    Conexion con;
    public insertarCodigoProveedor() {
        initComponents();
        try {
            con = new Conexion();
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(insertarCodigoProveedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese código proveedor: ");
    ...
    private void jButtonAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAceptarActionPerformed
        try{
            ...
            if(codigo>=1 & codigo<200){
                String reporte="";
                try {
                    reporte = con.pReporteProvee(codigo);
